...
BATCH=0x$(pack $OLDROLES  $INNER1)$(pack $OLDROLES $INNER2)$(pack $OLDROLES $INNER3)$(pack $OLDROLES $INNER4)$(pack $OLDROLES $INNER5)$(pack $OWNERLESS $INNER6)
...
for i in 1 2 3 4 5 6; do v=INNER$i; echo "inner $i: ${!v}"; done
